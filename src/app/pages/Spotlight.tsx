  ...
  }:CardProps) 
{
    ...
    <>
        <div className='pt-20 lg:pt-0 lg:w-[1388px]'>
            <div className='bg-gradient-to-b from-[#18282A] to-[#221A2C] lg:pb-0 pb-10'>
                <div className='p-10 flex justify-center items-center flex-col'>
                    <h1 className='text-white font-extrabold font-titleFont text-5xl mb-4 text-center'>Collection Spotlight</h1>
                    <p className='text-white text-sm font-bodyFont lg:w-[998px] text-center pb-10'>Discover extraordinary moments with our Spotlight Collection metatickets—exclusive access to premium events for an unforgettable experience. Grab yours today!</p>
                </div>
                <div className='flex justify-center relative'>
                    <div className='lg:w-[1388px] lg:h-[673px] w-[421px] h-auto gap-10 flex flex-col lg:flex-row lg:justify-center'>
                        ...
                        <SpotlightCard title="Sacramento River Cats" totalevents="48 Events" sport="Baseball" src="img5.jpg"/>
                        <div className='gap-10 hidden lg:flex'>
                        <SpotlightCard title="Las Vegas Aviators" totalevents="28 Events" sport="Baseball" src="img6.jpg"/>
                        <SpotlightCard title="New Jersey Devils" totalevents="15 Events" sport="Ice Hockey" src="img7.jpg"/>
                        </div>
